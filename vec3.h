...
class vec3 { // This class represents a 3D vector, it has x,y,z coordinates and some basic operations, it also has a color
...
// Dot and cross products for geometric operations
